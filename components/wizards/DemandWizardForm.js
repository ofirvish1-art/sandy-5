...
// The actual "אני צריך" wizard — shared between the standalone /demand page
// (bookmarkable, used for editing via ?edit=id) and the instant bottom-sheet
// modal opened from Home / the bottom nav's FAB.
export default function DemandWizardForm({ editId, onSuccess }) {
